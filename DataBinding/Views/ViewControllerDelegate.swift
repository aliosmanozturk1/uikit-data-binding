...
class ViewControllerDelegate: UIViewController {
    private let viewModel = UserViewModelDelegatePattern()
...
extension ViewControllerDelegate: UICollectionViewDataSource {
...
extension ViewControllerDelegate: ViewModelDelegate {
